...
void loop()
{
  ...
  calibratedlightLevel = map(lightLevel, 0, 1023, 0, 250);  // scale the lightLevel from 0 - 1023 range to 0 - 255 range.
  ...
  analogWrite(ledPin, 255 - lightLevel);    // set the led level based on the input lightLevel.
